...
class Utils {
    ...
    companion object {
        ...
        const val URI_CURRENCY_AUD = "latest?apikey=fca_live_u8YybRyp0D3N7bhJg9oynaaTJitTuzMlW9qhaphB&base_currency=AUD"
        const val URI_CURRENCY_CNY = "latest?apikey=fca_live_u8YybRyp0D3N7bhJg9oynaaTJitTuzMlW9qhaphB&base_currency=CNY"
        const val URI_CURRENCY_EUR = "latest?apikey=fca_live_u8YybRyp0D3N7bhJg9oynaaTJitTuzMlW9qhaphB&base_currency=EUR"
        const val URI_CURRENCY_HKD = "latest?apikey=fca_live_u8YybRyp0D3N7bhJg9oynaaTJitTuzMlW9qhaphB&base_currency=HKD"
        const val URI_CURRENCY_JPY = "latest?apikey=fca_live_u8YybRyp0D3N7bhJg9oynaaTJitTuzMlW9qhaphB&base_currency=JPY"
        const val URI_CURRENCY_USD = "latest?apikey=fca_live_u8YybRyp0D3N7bhJg9oynaaTJitTuzMlW9qhaphB&base_currency=USD"
        const val data = "data"
        const val AUD = "AUD"
        const val BGN = "BGN"
        const val BRL = "BRL"
